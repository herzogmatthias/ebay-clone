    ...
    <div class="grid gap-4 flex-auto grid-cols-1 place-items-center">
        ...
        <div class="form-control w-2/5">
          <label class="input-group input-group-vertical">
            ...
            <input type="text" name="name" id="name" placeholder="Type here" class="input input-bordered"  value={state.name}
                        onInput$={(e) => {
        ...
        <div class="form-control w-2/5">
          <label class="input-group input-group-vertical">
            ...
            <input type="text" name="description" placeholder="Type here" class="input input-bordered" value={state.description}
                      onInput$={(e) => {
        ...
        <div class="form-control w-2/5">
          <label class="input-group input-group-vertical">
            <span>Image</span>
            <input type="url" name="image" id="image" placeholder="Type here" class="input input-bordered"  value={state.image}
                        onInput$={(e) => {
        ...
        <div class="form-control w-2/5">
          <label class="input-group input-group-vertical">
            ...
            <input type="date" name="startDate" placeholder="Type here" class="input input-bordered" value={state.startDate}
                      onInput$={(e) => {
        ...
        <div class="form-control w-2/5">
          <label class="input-group input-group-vertical">
            <span>End Date</span>
            <input type="date" name="endDate" id="endDate" placeholder="Type here" class="input input-bordered"  value={state.endDate}
                        onInput$={(e) => {
        ...
        <div>
          <button class="btn btn-ghost btn-s" type="button" onClick$={addProduct}>save</button>
        </div>
